...
"
        >
          ...
          >
            ...
            <div className="relative w-full h-[220px] overflow-hidden border-b">
              <iframe
                ...
                title="MathMagic"
                className="absolute top-0 left-0 w-[1650px] h-[800px] scale-[0.35] origin-top-left pointer-events-none"
                loading="lazy"
              />
            </div>
          ...
          >
            ...
            href="https://www.keshvitravelsindore.in"
            target="_blank"
            rel="noopener noreferrer"
            className="block bg-white rounded-2xl border shadow-sm overflow-hidden hover:shadow-lg transition flex flex-col"
          >
            ...
            <div className="relative w-full h-[220px] overflow-hidden border-b">
              <iframe
                src="https://www.keshvitravelsindore.in/"
                title="CPCT"
                className="absolute top-0 left-0 w-[1650px] h-[800px] scale-[0.35] origin-top-left pointer-events-none"
                loading="lazy"
              />
            ...
            <div className="p-6 flex flex-col justify-between flex-grow">
              <div>
                <h3 className="font-bold text-xl text-gray-800">
                  Keshvi Travels Indore
                </h3>

                <p className="text-sm text-gray-600 mt-3 leading-relaxed">
                  Indore Premium Cabs
                  Ride with luxury. Book instantly or schedule your journey with seamless premium experience.
                </p>
              </div>
