  ...
  const internships = [
    {
      ...
      link: "https://leopardruns.com/",
      date: "March 2024 - Present",
      description: `In my current internship at LeopardRuns Innovation, I'm working as a Fullstack Developer focusing on frontend development using React.js, React Native, and SCSS to create interactive and user-friendly interfaces. Additionally, I'm working on backend APIs using Node.js, Express.js, PostgreSQL, and AWS to enable data storage and retrieval for the application.`,
    },
    {
      ...
      description: `During my internship at Unified Mentor Private Limited , I worked as a MERN Stack Developer, focusing on frontend development using React.js. I created interactive and user-friendly interfaces. Additionally, I was responsible for building the backend API using Node.js, Express.js, and MongoDB, enabling data storage and retrieval for the application.`,
    },  
  ];
            ...
            <div className=" relative">
              ...
              <div className=" flex flex-col gap-1 border-2 hover:border-yellow-400 hover:shadow-[0px_0px_16px_1px_rgba(0,0,0,0.1)] p-3 rounded-lg bg-white">
                ...
                <p className=" text-[.9rem] text-justify text-gray-500">
                  As an postgraduate student, I have a good understanding of
